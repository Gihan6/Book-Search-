package com.plcoding.bookpedia.book.prsentation.book_list.components
...
import cmp_bookpedia.composeapp.generated.resources.search_icon
        ...
        OutlinedTextField(
            ...
            leadingIcon = {
                Icon(
                    ...
                    tint = MaterialTheme.colorScheme.surfaceTint.copy(alpha = .65f)
                )
            },
            singleLine = true,
